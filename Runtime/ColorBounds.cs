...
namespace RandomColorUnity
{
    class ColorBounds
    {
        public Range HueRange { get; private set; }
        public Range SaturationRange { get; private set; }
        ...
        public ColorBounds(Range hueRange, Range saturationRange, int[] brightnessSteps)
        {
            HueRange = hueRange;
